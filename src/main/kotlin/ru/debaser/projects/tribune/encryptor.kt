...
fun main() {
    ...
    Files.write(Paths.get("./fcm/fcm-encrypted"), encrypted, StandardOpenOption.CREATE, StandardOpenOption.TRUNCATE_EXISTING)
    ...
    val decrypted = String(decryptor.decrypt(Files.readAllBytes(Paths.get("./fcm/fcm-encrypted"))))
    println(decrypted)
}